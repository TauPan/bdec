...
"""
    ...
    parser.add_option("--generate-line-pragmas", dest="line_pragmas", default=False,
                      help="Generate #line <n> \"<source file>\" pragmas for c code.
These are sometimes helpful in tracking down problems in the templates, but make the generated code a lot less human-readable. Defaults to False."
